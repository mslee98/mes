...
import {
  DELIVERY_WIDGET_CHART_HEIGHT,
  MONTH_CATEGORIES,
  DELIVERY_ITEMS,
  deliveryByYear,
  ANNUAL_DELIVERY_YEAR_LABELS,
  ANNUAL_DELIVERY_ITEMS,
  annualDeliveryByMetric,
  ANNUAL_CHART_COLORS,
  recentDeliveredProducts,
  productionStatusRows,
  AS_TYPE_YEARS,
  asTypeDistributionRows,
  type DeliveryYear,
  type DeliveryMetric,
  type AsTypeYear,
} from "./homeDashboardMockData";
